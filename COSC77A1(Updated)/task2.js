...
// Define a method to retrieve a vertex at a given index
...
// Define a render method for the WireframeMesh_Two class
...
// ################
    ...
    for (var i = 0; i < this.indices.length; i+=2)
    {
        ...
        xyz1 = fullTransformChain.multiplyVector(xyz1);
        xyz2 = fullTransformChain.multiplyVector(xyz2);

// ################ Edit your code below
        var uv1 = [xyz1[0] / xyz1[2], xyz1[1] / xyz1[2]];
        var uv2 = [xyz2[0] / xyz2[2], xyz2[1] / xyz2[2]];
