...
// ################
    // Translates system to origin before rotation
    var translate_1 = SimpleMatrix.translate(-point[0], -point[1], -point[2]);
    // For actual rotation itself
    var rotate = SimpleMatrix.rotate(angle, axis[0], axis[1], axis[2]);
    // Translate system back to origin after rotation
    var translate_2 = SimpleMatrix.translate(point[0], point[1], point[2]);

    // Translation to origin, rotate, translation back
    // Order matters in this case
    mat = mat.multiply(translate_2).multiply(rotate).multiply(translate_1);
