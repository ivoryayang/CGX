...
// ################ Normal Matrix
    ...
    var CameraPosition= view.inverse().transformPoint(vec);

    gl.uniformMatrix4fv(gl.getUniformLocation(this.shaderProgram, "NormalMatrix"), false, model.inverse().m);
    gl.uniformMatrix4fv(gl.getUniformLocation(this.shaderProgram, "ModelMatrix"), false, model.transpose().m);
    console.log(CameraPosition);
    gl.uniform3f(gl.getUniformLocation(this.shaderProgram, "CameraPosition"), false, CameraPosition.x, CameraPosition.y, CameraPosition.z); //inverse of view at (0,0,0)
